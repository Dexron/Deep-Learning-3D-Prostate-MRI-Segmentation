...
from preprocess_Copy1 import prepare
from Utilities_Copy1 import train
...
model_dir = os.path.join(in_dir, "Models2")

os.makedirs(model_dir, exist_ok=True)


train_loader, val_loader, test_loader = prepare(in_dir, pixdim=(0.5, 0.5, 2.0), spatial_size=[128, 128, 15], cache=True)

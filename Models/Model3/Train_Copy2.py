...
from preprocess_Copy2 import prepare
from Utilities_Copy2 import train
...
model_dir = os.path.join(in_dir, "Models3")

os.makedirs(model_dir, exist_ok=True)


train_loader, val_loader, test_loader = prepare(in_dir,spatial_size=[128, 128, 15], cache=True)
